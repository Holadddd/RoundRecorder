//
//  URStreamBasicDescription.swift
//  UrbanRecorder
//
...
typealias URStreamBasicDescription = AudioStreamBasicDescription
extension URStreamBasicDescription {
    ...
    func fromText(_ inTextDesc: UnsafePointer<CChar>, fmt: inout URStreamBasicDescription) -> Bool {
        var p = inTextDesc
        
        fmt = URStreamBasicDescription()
