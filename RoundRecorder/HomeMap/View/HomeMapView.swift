                    ...
                    ZStack{
                        VStack {
                            MapView(isSetupCurrentLocation: $viewmodel.isSetupCurrentLocation,
                                    ...
                                    userAnootion: $viewmodel.userAnootion,
                                    setNeedUpdateUserAnootionOnMap: $viewmodel.setNeedUpdateUserAnootionOnMap,
                                    sourceAnnotation: $viewmodel.sourceAnnotation,
                                    setNeedUpdateSourceAnnotationOnMap: $viewmodel.setNeedUpdateSourceAnnotationOnMap,
                                    displayPathWithRoutes: $viewmodel.displayPathWithRoutes,
                                    setNeedUpdateNewPathAnnotationsOnMap: $viewmodel.setNeedUpdateNewPathAnnotationsOnMap,
